...
boolean clientMode = com.selectica.tools.DetermineUtils.isClientMode(com.selectica.accountmanagement.RequestStateHolder.getHttpRequest());
   if(isMobile){
%>
<%@ include file="/privateLabels/RCFdev3/inc_dyn_mobile_subHeaderBorrower.jsp" %>
<% }else{ %>
...
<script language="JavaScript" type="text/javascript">
    ...
    <script language="JavaScript" type="text/javascript" src="privateLabels/RCFdev3/new_ui/main.js"></script>
    <link rel="stylesheet" type="text/css" href="privateLabels/RCFdev3/new_ui/main.css" />
